  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Atlas-prefixed aliases — the Developer LLM, seeing `--atlas-border`
        // in design-tokens guidance, frequently writes `border-atlas-border`
        // by analogy. Register the aliased names so the hallucinated spellings
        // build successfully instead of failing the sandbox with
        // `The 'border-atlas-border' class does not exist`.
        "atlas-border": "hsl(var(--atlas-border))",
        "atlas-input": "hsl(var(--atlas-input))",
        "atlas-ring": "hsl(var(--atlas-ring))",
        "atlas-background": "hsl(var(--atlas-background))",
        "atlas-foreground": "hsl(var(--atlas-foreground))",
        "atlas-primary": {
