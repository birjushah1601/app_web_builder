    ...
    <nav className="h-full overflow-y-auto bg-zinc-900 py-2 text-sm text-zinc-300">
      {files.length === 0 ? (
        <div className="px-3 py-4 text-xs text-zinc-400">
          <p className="mb-2 font-medium text-zinc-200">No files yet</p>
          <p className="leading-relaxed">
            The Code view reads from the spec-graph-sync mirror, which isn&apos;t populated by ritual flows yet.
            For now, use the <span className="text-zinc-200">Canvas</span> view to see the live generated site.
          </p>
        </div>
      ) : (
        <ul>
