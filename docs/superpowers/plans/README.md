...
| 7 | `2026-04-20-skill-runtime.md` | **C.1 — Skill Runtime** | TS package: skill frontmatter parser, `SkillRegistry`, `IntentClassifier` interface (mocked in C.1, real in D.1), composes-graph resolver, pin.json version check | 20 tasks, TDD | Shipped (pending merge — TODO: update SHA post-merge) |
...
A.1 (Plans[1])
  ...
  └─ Unit B — Schema & Validation
       ...
       └─ B.2 (Plans[6], shipped)
            ...
            │    └─ Unit C — Skill Framework  [from Plans[9] Unit C]
